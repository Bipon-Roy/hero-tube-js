...
const displayCard = async (categoryId) => {
        ...
        cardNumber.forEach((cardInfo) => {
          ...
          <div class="card bg-base-100 mt-6">
              ...
              <div class="card-body px-0 py-4">
                  <div class="p-1 bg-[#171717] w-fit rounded-md absolute right-3 top-[160px]">
                      <p class="text-white text-sm">3hrs 56 min ago</p>
                  </div>
    ...
    //     emptyItem.innerHTML = `<img src="./images/Icon.png" alt="Icon" class="" />
    //     <p class="text-[#171717] font-bold text-3xl text-center">
    //         Oops!! Sorry, There is no <br />content here
    //     </p>`;
    //     noDataContainer.appendChild(emptyItem);
    // }
};
fetchCategory();
